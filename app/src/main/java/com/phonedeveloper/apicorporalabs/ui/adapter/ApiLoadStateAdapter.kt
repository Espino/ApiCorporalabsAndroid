...
import com.phonedeveloper.apicorporalabs.databinding.LoadStateFooterBinding

class ApiLoadStateAdapter(private val retry: () -> Unit) :
    LoadStateAdapter<ApiLoadStateAdapter.LoadStateViewHolder>() {
